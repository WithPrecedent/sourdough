...
class Progression(sourdough.Component, collections.abc.MutableSequence):
    ...
    Args:
        contents (Optional[Sequence[sourdough.Component]]): stored iterable of 
...
class Director(Progression):
    ...
    Args:
        ...
        contents (Optional[Sequence[Union['sourdough.Stage', str]]]): list of 
