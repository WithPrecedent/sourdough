"""
elements: sourdough base Element subclasses
...
class Lexicon(sourdough.Element, collections.abc.MutableMapping):
    ...
    Args:
        ...
        name (str): designates the name of a class instance that is used for 
            ...
            the 'get_name' method in sourdough.Element. If that method is not overridden 
